...
def _detect_language(text: str) -> str:
    ...
    if any(c in text for c in "äöüßÄÖÜ") or len(
        {"der", "die", "das", "und", "welche", "welcher", "nicht", "von", "mit", "haben", "ist", "sind"} & words
    ) >= 2:
        return "de"

    # Italian: accented è plus common Italian words.
    if "è" in text or len(
        {"il", "la", "le", "per", "con", "che", "del", "delle", "degli", "sono", "questo", "qual"} & words
    ) >= 2:
        return "it"

    # French: ê/â/î/ô/û/ç/œ are fairly French-specific; also check common words.
    if any(c in text for c in "êâîôûçœæÊÂÎÔÛÇ") or len(
        {"les", "des", "est", "dans", "avec", "sont", "cette", "pour", "qui", "vous", "nous"} & words
    ) >= 2:
        return "fr"

    # Portuguese: ã/õ are very distinctive (not in Spanish or French).
    if any(c in text for c in "ãõÃÕ") or len(
        {"dos", "das", "numa", "pelos", "pelas", "você", "nossa", "pelo"} & words
    ) >= 2:
        return "pt"

    # Spanish: ñ/¿/¡ are distinctive; also check Spanish-specific words.
    if any(c in text for c in "ñÑ¿¡") or len(
        {"los", "las", "del", "una", "por", "para", "con", "que", "son", "cuál", "cuáles"} & words
    ) >= 2:
        return "es"
...
_EXTRA_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "zh": {
        "DATA SNAPSHOT": "数据快照", "INTERNAL | CONFIDENTIAL": "内部 | 机密",
        "Confidential - Internal Use Only": "机密 – 仅供内部使用",
        "Source: Gold Layer · Athena": "来源：Gold 层 · Athena",
        "page_fmt": "第 {n} 页，共 {m} 页", "DATA ENGINEER": "数据工程师",
        "Generated:": "生成时间：", "Period:": "时间段：",
        "Periods Covered": "覆盖时段", "Total Entries": "条目总数",
        "All Entries": "所有条目", "Months": "个月", "Total": "总计", "All": "全部",
        "total_metric_all_fmt": "{metric} 合计（全部）",
    },
    "ja": {
        "DATA SNAPSHOT": "データスナップショット", "INTERNAL | CONFIDENTIAL": "社内 | 機密",
        "Confidential - Internal Use Only": "機密 – 社内使用限定",
        "Source: Gold Layer · Athena": "出典：Gold レイヤー · Athena",
        "page_fmt": "{n} / {m} ページ", "DATA ENGINEER": "データエンジニア",
        "Generated:": "生成日時：", "Period:": "期間：",
        "Periods Covered": "対象期間", "Total Entries": "合計エントリ数",
        "All Entries": "全エントリ", "Months": "ヶ月", "Total": "合計", "All": "全",
        "total_metric_all_fmt": "{metric} 合計（全体）",
    },
    "ko": {
        "DATA SNAPSHOT": "데이터 스냅샷", "INTERNAL | CONFIDENTIAL": "내부 | 기밀",
        "Confidential - Internal Use Only": "기밀 – 내부 전용",
        "Source: Gold Layer · Athena": "출처: Gold 레이어 · Athena",
        "page_fmt": "{n} / {m} 페이지", "DATA ENGINEER": "데이터 엔지니어",
        "Generated:": "생성:", "Period:": "기간:",
        "Periods Covered": "포함된 기간", "Total Entries": "총 항목 수",
        "All Entries": "모든 항목", "Months": "개월", "Total": "합계", "All": "전체",
        "total_metric_all_fmt": "{metric} 합계(전체)",
    },
    "ar": {
        "DATA SNAPSHOT": "لقطة البيانات", "INTERNAL | CONFIDENTIAL": "داخلي | سري",
        "Confidential - Internal Use Only": "سري – للاستخدام الداخلي فقط",
        "Source: Gold Layer · Athena": "المصدر: طبقة Gold · Athena",
        "page_fmt": "صفحة {n} من {m}", "DATA ENGINEER": "مهندس البيانات",
        "Generated:": "تم التوليد:", "Period:": "الفترة:",
        "Periods Covered": "الفترات المشمولة", "Total Entries": "إجمالي الإدخالات",
        "All Entries": "جميع الإدخالات", "Months": "أشهر", "Total": "الإجمالي", "All": "الكل",
        "total_metric_all_fmt": "إجمالي {metric} (الكل)",
    },
    "ru": {
        "DATA SNAPSHOT": "СНИМОК ДАННЫХ", "INTERNAL | CONFIDENTIAL": "ВНУТРЕННИЙ | КОНФИДЕНЦИАЛЬНО",
        ...
        "page_fmt": "Страница {n} из {m}", "DATA ENGINEER": "ИНЖЕНЕР ДАННЫХ",
        "Generated:": "Создано:", "Period:": "Период:",
        "Periods Covered": "Охваченные периоды", "Total Entries": "Всего записей",
        "All Entries": "Все записи", "Months": "месяцев", "Total": "Всего", "All": "Все",
        "total_metric_all_fmt": "Всего {metric} (Все)",
    },
    "el": {
        "DATA SNAPSHOT": "ΣΤΙΓΜΙΌΤΥΠΟ ΔΕΔΟΜΈΝΩΝ", "INTERNAL | CONFIDENTIAL": "ΕΣΩΤΕΡΙΚΟ | ΕΜΠΙΣΤΕΥΤΙΚΟ",
        "Confidential - Internal Use Only": "Εμπιστευτικό – Μόνο για εσωτερική χρήση",
        "Source: Gold Layer · Athena": "Πηγή: Gold Layer · Athena",
        "page_fmt": "Σελίδα {n} από {m}", "DATA ENGINEER": "ΜΗΧΑΝΙΚΟΣ ΔΕΔΟΜΕΝΩΝ",
        "Generated:": "Δημιουργήθηκε:", "Period:": "Περίοδος:",
        "Periods Covered": "Καλυπτόμενες περίοδοι", "Total Entries": "Σύνολο εγγραφών",
        "All Entries": "Όλες οι εγγραφές", "Months": "μήνες", "Total": "Σύνολο", "All": "Όλες",
        "total_metric_all_fmt": "Σύνολο {metric} (Όλες)",
        "Summary": "Περίληψη",
    },
    "he": {
        "DATA SNAPSHOT": "תצלום נתונים", "INTERNAL | CONFIDENTIAL": "פנימי | סודי",
        "Confidential - Internal Use Only": "סודי – לשימוש פנימי בלבד",
        "Source: Gold Layer · Athena": "מקור: Gold Layer · Athena",
        "page_fmt": "עמוד {n} מתוך {m}", "DATA ENGINEER": "מהנדס נתונים",
        "Generated:": "נוצר:", "Period:": "תקופה:",
        "Periods Covered": "תקופות מכוסות", "Total Entries": "סך רשומות",
        "All Entries": "כל הרשומות", "Months": "חודשים", "Total": "סך הכל", "All": "הכל",
        "total_metric_all_fmt": "סך {metric} (הכל)",
        "Summary": "סיכום",
    },
    "th": {
        "DATA SNAPSHOT": "สแนปช็อตข้อมูล", "INTERNAL | CONFIDENTIAL": "ภายใน | ลับ",
        "Confidential - Internal Use Only": "ลับ – สำหรับใช้ภายในเท่านั้น",
        "Source: Gold Layer · Athena": "ที่มา: Gold Layer · Athena",
        "page_fmt": "หน้า {n} จาก {m}", "DATA ENGINEER": "วิศวกรข้อมูล",
        "Generated:": "สร้างเมื่อ:", "Period:": "ช่วงเวลา:",
        "Periods Covered": "ช่วงเวลาที่ครอบคลุม", "Total Entries": "รายการทั้งหมด",
        "All Entries": "รายการทั้งหมด", "Months": "เดือน", "Total": "รวม", "All": "ทั้งหมด",
...
_COL_TRANSLATIONS: dict[str, dict[str, str]] = {
    "de": {
        "year_month": "Monat", "total_revenue": "Gesamtumsatz", "order_count": "Bestellungen",
        "unique_customers": "Eindeutige Kunden", "customer_id": "Kunden-ID",
        "first_name": "Vorname", "last_name": "Nachname", "country": "Land",
        "lifetime_value": "Lifetime-Wert", "segment": "Segment",
        "payment_method": "Zahlungsmethode", "payment_status": "Zahlungsstatus",
        "total_transactions": "Transaktionen", "successful_transactions": "Erfolgreiche Transaktionen",
        "success_rate_pct": "Erfolgsrate (%)", "total_payment_volume": "Zahlungsvolumen",
        "lost_revenue": "Entgangener Umsatz", "carrier_name": "Spediteur",
        "total_shipments": "Sendungen", "successful_deliveries": "Lieferungen",
        "avg_delivery_days": "Ø Liefertage", "category": "Kategorie", "brand": "Marke",
        "units_sold": "Verkaufte Einheiten", "revenue_rank": "Umsatz-Rang",
        "total_orders": "Bestellungen gesamt", "product_name": "Produkt",
        "revenue": "Umsatz",
    },
    "it": {
        "year_month": "Mese", "total_revenue": "Ricavo totale", "order_count": "Ordini",
        "unique_customers": "Clienti unici", "customer_id": "ID Cliente",
        "first_name": "Nome", "last_name": "Cognome", "country": "Paese",
        "lifetime_value": "Valore a vita", "segment": "Segmento",
        "payment_method": "Metodo di pagamento", "payment_status": "Stato pagamento",
        "total_transactions": "Transazioni", "successful_transactions": "Transazioni riuscite",
        "success_rate_pct": "Tasso di successo (%)", "total_payment_volume": "Volume pagamenti",
        "lost_revenue": "Ricavo perso", "carrier_name": "Corriere",
        "total_shipments": "Spedizioni", "successful_deliveries": "Consegne riuscite",
        "avg_delivery_days": "Giorni medi consegna", "category": "Categoria", "brand": "Marca",
        "units_sold": "Unità vendute", "revenue_rank": "Posizione", "total_orders": "Ordini totali",
        "product_name": "Prodotto", "revenue": "Ricavo",
    },
    "fr": {
        "year_month": "Mois", "total_revenue": "Chiffre d'affaires", "order_count": "Commandes",
        "unique_customers": "Clients uniques", "customer_id": "ID Client",
        "first_name": "Prénom", "last_name": "Nom", "country": "Pays",
        "lifetime_value": "Valeur à vie", "segment": "Segment",
        "payment_method": "Mode de paiement", "payment_status": "Statut paiement",
        "total_transactions": "Transactions", "successful_transactions": "Transactions réussies",
        "success_rate_pct": "Taux de succès (%)", "total_payment_volume": "Volume paiements",
        "lost_revenue": "Revenus perdus", "carrier_name": "Transporteur",
        "total_shipments": "Expéditions", "successful_deliveries": "Livraisons réussies",
        "avg_delivery_days": "Jours livraison moy.", "category": "Catégorie", "brand": "Marque",
        "units_sold": "Unités vendues", "revenue_rank": "Classement", "total_orders": "Commandes totales",
        "product_name": "Produit", "revenue": "CA",
    },
    "es": {
        "year_month": "Mes", "total_revenue": "Ingresos totales", "order_count": "Pedidos",
        "unique_customers": "Clientes únicos", "customer_id": "ID Cliente",
        "first_name": "Nombre", "last_name": "Apellido", "country": "País",
        "lifetime_value": "Valor de por vida", "segment": "Segmento",
        "payment_method": "Método de pago", "payment_status": "Estado del pago",
        "total_transactions": "Transacciones", "successful_transactions": "Transacciones exitosas",
        "success_rate_pct": "Tasa de éxito (%)", "total_payment_volume": "Volumen de pagos",
        "lost_revenue": "Ingresos perdidos", "carrier_name": "Transportista",
        "total_shipments": "Envíos", "successful_deliveries": "Entregas exitosas",
        "avg_delivery_days": "Días entrega prom.", "category": "Categoría", "brand": "Marca",
        "units_sold": "Unidades vendidas", "revenue_rank": "Clasificación", "total_orders": "Pedidos totales",
        "product_name": "Producto", "revenue": "Ingresos",
    },
    "pt": {
        "year_month": "Mês", "total_revenue": "Receita total", "order_count": "Pedidos",
        "unique_customers": "Clientes únicos", "customer_id": "ID do Cliente",
        "first_name": "Nome", "last_name": "Sobrenome", "country": "País",
        "lifetime_value": "Valor vitalício", "segment": "Segmento",
        "payment_method": "Método de pagamento", "payment_status": "Status do pagamento",
        "total_transactions": "Transações", "successful_transactions": "Transações bem-sucedidas",
        "success_rate_pct": "Taxa de sucesso (%)", "total_payment_volume": "Volume de pagamentos",
        "lost_revenue": "Receita perdida", "carrier_name": "Transportadora",
        "total_shipments": "Envios", "successful_deliveries": "Entregas bem-sucedidas",
        "avg_delivery_days": "Dias entrega méd.", "category": "Categoria", "brand": "Marca",
        "units_sold": "Unidades vendidas", "revenue_rank": "Classificação", "total_orders": "Pedidos totais",
        "product_name": "Produto", "revenue": "Receita",
    },
    "zh": {
        "year_month": "月份", "total_revenue": "总收入", "order_count": "订单数",
        "unique_customers": "独立客户", "customer_id": "客户ID", "first_name": "名",
        "last_name": "姓", "country": "国家", "lifetime_value": "终身价值", "segment": "细分",
        "payment_method": "支付方式", "payment_status": "支付状态", "total_transactions": "交易数",
        "successful_transactions": "成功交易", "success_rate_pct": "成功率(%)",
        "total_payment_volume": "支付总额", "lost_revenue": "损失收入", "carrier_name": "承运商",
        "total_shipments": "发货数", "successful_deliveries": "成功交付",
        "avg_delivery_days": "平均交付天数", "category": "类别", "brand": "品牌",
        "units_sold": "销售数量", "revenue_rank": "收入排名", "total_orders": "总订单",
        "product_name": "产品", "revenue": "收入",
    },
    "ja": {
        "year_month": "年月", "total_revenue": "総収益", "order_count": "注文数",
        "unique_customers": "ユニーク顧客", "customer_id": "顧客ID", "first_name": "名",
        "last_name": "姓", "country": "国", "lifetime_value": "生涯価値", "segment": "セグメント",
        "payment_method": "支払方法", "payment_status": "支払状態", "total_transactions": "取引数",
        "successful_transactions": "成功取引", "success_rate_pct": "成功率(%)",
        "total_payment_volume": "支払総額", "lost_revenue": "損失収益", "carrier_name": "配送業者",
        "total_shipments": "出荷数", "successful_deliveries": "配送成功",
        "avg_delivery_days": "平均配送日数", "category": "カテゴリ", "brand": "ブランド",
        "units_sold": "販売数", "revenue_rank": "収益ランク", "total_orders": "総注文",
        "product_name": "商品", "revenue": "収益",
    },
    "ko": {
        "year_month": "월", "total_revenue": "총 매출", "order_count": "주문 수",
        "unique_customers": "고유 고객", "customer_id": "고객 ID", "first_name": "이름",
        "last_name": "성", "country": "국가", "lifetime_value": "생애 가치", "segment": "세그먼트",
        "payment_method": "결제 방법", "payment_status": "결제 상태", "total_transactions": "거래 수",
        "successful_transactions": "성공 거래", "success_rate_pct": "성공률(%)",
        "total_payment_volume": "결제 총액", "lost_revenue": "손실 매출", "carrier_name": "운송업체",
        "total_shipments": "배송 수", "successful_deliveries": "성공 배송",
        "avg_delivery_days": "평균 배송일", "category": "카테고리", "brand": "브랜드",
        "units_sold": "판매량", "revenue_rank": "매출 순위", "total_orders": "총 주문",
        "product_name": "제품", "revenue": "매출",
    },
    "ar": {
        "year_month": "الشهر", "total_revenue": "إجمالي الإيرادات", "order_count": "الطلبات",
        "unique_customers": "عملاء فريدون", "customer_id": "معرف العميل",
        "first_name": "الاسم الأول", "last_name": "اسم العائلة", "country": "الدولة",
        "lifetime_value": "القيمة الإجمالية", "segment": "الشريحة",
        "payment_method": "طريقة الدفع", "payment_status": "حالة الدفع",
        "total_transactions": "المعاملات", "successful_transactions": "المعاملات الناجحة",
        "success_rate_pct": "معدل النجاح (%)", "total_payment_volume": "حجم المدفوعات",
        "lost_revenue": "الإيرادات المفقودة", "carrier_name": "الناقل",
        "total_shipments": "الشحنات", "successful_deliveries": "التسليمات الناجحة",
        "avg_delivery_days": "متوسط أيام التسليم", "category": "الفئة", "brand": "العلامة التجارية",
        "units_sold": "الوحدات المباعة", "revenue_rank": "ترتيب الإيرادات",
        "total_orders": "إجمالي الطلبات", "product_name": "المنتج", "revenue": "الإيرادات",
    },
    "ru": {
        "year_month": "Месяц", "total_revenue": "Общая выручка", "order_count": "Заказы",
        "unique_customers": "Уникальные клиенты", "customer_id": "ID клиента",
        "first_name": "Имя", "last_name": "Фамилия", "country": "Страна",
        "lifetime_value": "Пожизненная ценность", "segment": "Сегмент",
        "payment_method": "Метод оплаты", "payment_status": "Статус оплаты",
        "total_transactions": "Транзакции", "successful_transactions": "Успешные транзакции",
        "success_rate_pct": "Успешность (%)", "total_payment_volume": "Объём платежей",
        "lost_revenue": "Потерянная выручка", "carrier_name": "Перевозчик",
        "total_shipments": "Отправления", "successful_deliveries": "Успешные доставки",
        "avg_delivery_days": "Ср. дней доставки", "category": "Категория", "brand": "Бренд",
        "units_sold": "Продано единиц", "revenue_rank": "Рейтинг выручки",
        "total_orders": "Всего заказов", "product_name": "Продукт", "revenue": "Выручка",
    },
}
...
_MONTH_NAMES: dict[str, list[str]] = {
    ...
    "fr": ["Jan.", "Fév.", "Mars", "Avr.", "Mai", "Juin", "Juil.", "Aoû.", "Sep.", "Oct.", "Nov.", "Déc."],
...
def _extract_kpi_tiles(columns: list[str], rows: list[dict], lang: str = "en") -> list[tuple[str, str, str, str]]:
    ...
    if cat_cols and numeric_cols:
        ...
        try:
            ...
            base_label = re.sub(r"^Total\s+", "", metric_label, flags=re.IGNORECASE)  # kept for compat
            if is_time_cat and len(rows) >= 2:
        ...
        tiles.append((_t("Total Results", lang) if _t("Total Results", lang) != "Total Results" else "Total Results", str(len(rows)), "", ""))
...
def _cached_build_pdf(
    ...
    _PDF_MON_HINTS = {
        "revenue", "amount", "sales", "profit", "spend", "cost", "price", "income",
        "value", "payment", "volume", "lifetime",
    }
    ...
    _pdf_num_clean = [c for c in _pdf_numeric if not c.lower().endswith("_id") and c.lower() != "id"]
...
def _render_turn(turn: dict, form_key: str) -> None:
    ...
    if kpi_tiles:
        ...
        for tcol, (metric_lbl, value, sub_lbl, badge) in zip(_tile_col_list, kpi_tiles, strict=False):
            with tcol:
